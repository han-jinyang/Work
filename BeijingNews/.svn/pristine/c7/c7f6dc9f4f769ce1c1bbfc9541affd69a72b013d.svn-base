...
//    private String uploadFile = "/sdcard/test.mp3";
    ...
    private String actionUrl = "http://192.168.21.165:8080/FileUpload/FileUploadServlet";
    ...
    private void uploadFile() {
        ...
        String uploadUrl = "http://192.168.21.165:8080/FileUpload/FileUploadServlet";
        String end = "\r\n";
        String twoHyphens = "--";
        String boundary = "******";
        try {
            ...
            Toast.makeText(this, "上传成功" + result, Toast.LENGTH_LONG).show();
            dos.close();
            is.close();
