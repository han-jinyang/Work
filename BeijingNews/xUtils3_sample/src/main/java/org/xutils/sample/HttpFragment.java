...
public class HttpFragment extends BaseFragment {
    ...
    private void onTest2Click(View view) {
        RequestParams params = new RequestParams("http://192.168.21.165:8080/FileUpload/FileUploadServlet");
...
//            params.addBodyParameter(
//                    "file2",
//                    new FileInputStream(new File("/sdcard/2.jpg")),
//                    "image/jpeg",
//                    // 测试中文文件名
...
//            String url = et_url.getText().toString();
            String url = "http://192.168.21.165:8080/oppo.mp4";
            String label = i + "xUtils_" + System.nanoTime();
            DownloadManager.getInstance().startDownload(
                    url, label,
                    "/sdcard/beijingnews/xUtils/" + label + ".mp4", true, false, null);
        }
    }
